...
export const barChartDevicePerformance = [
  {
    name: "Health",
    data: [50, 70, 60, 90, 61, 55],
  },
];

export const barChartOptionsDevicePerformance = {
  chart: {
    toolbar: {
      show: false,
    },
  ...
  xaxis: {
    categories: ["801 CH", "835 P", "850 P", "855 PH", "P80AVB", "P80SB"],
    show: false,
    labels: {
      show: true,
      style: {
